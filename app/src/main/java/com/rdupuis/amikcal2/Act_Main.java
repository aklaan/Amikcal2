...
import com.rdupuis.amikcal2.commons.Act_Calendar;
import com.rdupuis.amikcal2.commons.Act_Techinfo;
...
import com.rdupuis.amikcal2.data.DatabaseObj;
import com.rdupuis.amikcal2.day.Act_Day;
import com.rdupuis.amikcal2.energy.Act_Energy_Food_List;
import com.rdupuis.amikcal2.equivalence.Act_EquivalenceList;
import com.rdupuis.amikcal2.unity.Unity;
import com.rdupuis.amikcal2.useractivity.UserActivities_FragmentsSlider;

import java.io.File;
import java.util.ArrayList;

//import android.content.ContentValues;
//import com.rdupuis.amikcal2.ContentDescriptor;
...
public class Act_Main extends Activity {
	...
	* cette lecture va permettre de déclancher la mise à jour de la base si la version de la DB a chang�e.
	*/
	...
	* verifierMiseAJourDB
	* 
	* la mise � jour de la database est une op�ration qui peu �tre longue.
	* ici, on pr�vient d'utilisateur qu'il faut patienter si une mise 
	* � jour est necessaire.
    *	
	**********************************************/
		...
		if (ToolBox.getAmikcalDbVersion()<DatabaseObj.DATABASE_VERSION){
	       ...
	       new Thread((new Runnable() {
	           ...
	           public void run() {
	                  ...
	                  Message msg = null;
	            	  String progressBarData = "Mise � jour de la base";
	...
	/**
	 * createRefActivityCatalog : m�thode g�n�rique qui permet de cr�er un fichier 
	 * catalogue d'activit�es dans le cas o� i n'y en a pas
	 */
	...
	/**
	 * isActivityCatalogExist : teste l'existence d'un catalogue d'activit�
	 * 
	 */
