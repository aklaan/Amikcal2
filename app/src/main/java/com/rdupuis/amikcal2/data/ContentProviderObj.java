package com.rdupuis.amikcal2.data;
...
import com.rdupuis.amikcal2.data.ContentDescriptorObj.REQUESTS_LIST;

import com.rdupuis.amikcal2.data.ContentDescriptorObj.TOKEN_MAP;
...
public class ContentProviderObj extends ContentProvider {
    ...
    /******************************************************************************
     * A la cr�ation de la base de donn�e
     *****************************************************************************/
    @Override
    ...
    /******************************************************************************
     * Gestion des INSERT on re�oit une URI et on doit trouver le TOKEN
     *****************************************************************************/
