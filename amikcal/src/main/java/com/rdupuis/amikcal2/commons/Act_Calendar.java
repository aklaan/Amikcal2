...
public class Act_Calendar extends Activity {
	...
	/***
	 * D�terminier le libell� d'un mois � parti de sont num�ro.
	 * @param monthNumber
	 * @return (String) libell� du mois 
	 */
	...
	private String getMonthLabel(int monthNumber){
		...
		case Calendar.JANUARY:result="Janvier";break;
		case Calendar.FEBRUARY:result="Fevrier";break;
		case Calendar.MARCH:result="Mars";break;
		case Calendar.APRIL:result="Avril";break;
		case Calendar.MAY:result="Mai";break;
		case Calendar.JUNE:result="Juin";break;
		case Calendar.JULY:result="Juillet";break;
		case Calendar.AUGUST:result="Aout";break;
		case Calendar.SEPTEMBER:result="Septembre";break;
		case Calendar.OCTOBER:result="Octobre";break;
		case Calendar.NOVEMBER:result="Novembre";break;
		case Calendar.DECEMBER:result="Decembre";break;
